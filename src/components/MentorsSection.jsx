      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {filteredMentors.map((mentor) => (
            <div
              key={mentor.id}
              className="flex-none w-[280px] sm:w-[320px] bg-neutral-900 rounded-3xl overflow-hidden border border-neutral-800/80 hover:border-neutral-700 transition-all group hover:-translate-y-1.5 duration-300 shadow-xl"
            >
