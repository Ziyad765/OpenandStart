          ...
          <table className="w-full text-left border-collapse min-w-[640px]">
            ...
            <tbody className="text-sm divide-y divide-neutral-800/60 font-medium">
              ...
              <tr>
                ...
                <td className="py-4 px-6 text-emerald-400 font-bold bg-neutral-900">Part-Time (10–15 hrs/week)</td>
              </tr>
              <tr>
                <td className="py-4 px-6 text-white font-bold">Total Investment</td>
                <td className="py-4 px-6 text-neutral-400 font-semibold">₹11,00,000 – ₹20,00,000</td>
                <td className="py-4 px-6 text-neutral-400 font-semibold">₹1,65,000 + Equity</td>
                <td className="py-4 px-6 bg-neutral-900 rounded-b-2xl">
                  <span className="text-white font-black text-xl">₹82,000</span>
                  <span className="text-xs font-normal text-neutral-400 ml-1">or ₹6,500/mo</span>
                </td>
              </tr>
            </tbody>
          </table>
