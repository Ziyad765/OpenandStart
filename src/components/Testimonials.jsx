...
export default function Testimonials() {
  const reviews = [
    ...
    },
    {
      ...
      review: "I was drawn in by Open & Start’s genuine desire to empower others. I went from having a vague concept to launching a fully functional MVP withpaying customers in under two months.",
      rating: 5
    }
  ];
    ...
    <section id="testimonials" className="py-24 bg-white text-neutral-900 border-b border-neutral-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((r, idx) => (
            <div key={idx} className="p-8 rounded-3xl bg-neutral-50 border border-neutral-200/80 flex flex-col justify-between hover:shadow-lg transition-shadow">
              <div>
              ...
              <div className="pt-4 border-t border-neutral-200/60">
                <h4 className="text-base font-bold text-neutral-950">{r.name}</h4>
